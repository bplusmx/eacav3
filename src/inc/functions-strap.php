...
function bootstrap_menu_objects( $sorted_menu_items, $args) {
	if ($args->theme_location == 'primary') {		$current = array( 'current-menu-ancestor', 'current-menu-item' );
		$registry = array();
...
function bootstrap_comment_form_defaults( $defaults ) {
	...
	$defaults['fields'] = array(
		'author' => '<div class="form-group comment-form-author">' .
				'<label for="author" class="col-sm-3 control-label">' . __( 'Name', 'acapulco' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
				'<div class="col-sm-9">' .
					'<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '"  class="form-control"' . $aria_req . ' />' .
				'</div>' .
			'</div>',
		'email'  => '<div class="form-group comment-form-email">' .
				'<label for="email" class="col-sm-3 control-label">' . __( 'Email', 'acapulco' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
				'<div class="col-sm-9">' .
		...
		'url'    => '<div class="form-group comment-form-url">' .
			'<label for="url" class="col-sm-3 control-label"">' . __( 'Website', 'acapulco' ) . '</label>' .
				'<div class="col-sm-9">' .
	...
	$defaults['comment_field'] = '<div class="form-group comment-form-comment">' .
		'<label for="comment" class="col-sm-3 control-label">' . _x( 'Comment', 'noun', 'acapulco' ) . '</label>' .
			'<div class="col-sm-9">' .
