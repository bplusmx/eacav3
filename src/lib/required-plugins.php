...
add_action('tgmpa_register', 'aca_theme_required_plugins');

/**
 * Plugins necesarios y recomendados para esta plantilla
 *
 */
function aca_theme_required_plugins()
{
	// Change this to your theme text domain, used for internationalising strings
	$theme_text_domain = 'acapulco';
	...
	$plugins = array(
		 ...
		 */
		 array(
 			'name'				=> 'Custom Sidebars - Dynamic Widget Area Manager',
		...
		array(
			'name'				=> 'Search Keyword Redirect',
			'slug'				=> 'wp-search-keyword-redirect',
			'required'			=> false
		),
		array(
		...
		array(
			'name'				=> 'Comments Evolved for WordPress',
			'slug'				=> 'gplus-comments',
			'required'			=> false
		),
		array(
